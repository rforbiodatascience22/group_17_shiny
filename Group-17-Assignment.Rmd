...
Understanding of the app structures and functions including organizing the outlooks.
...
The pharma-company app concept should be easier and better than the previous version. The changed functionality might give medical doctors feel unfamiliar with the new outlook and need time to be familiar and use the app.

# What other challenges and limitations do you see shiny apps may have? Please elaborate.  
There are many options for creating primary layout and module, the new developer need time to learn the app and find the proper outlook with their own user.
